  ...
  "1.7" === t.fn.jquery.substring(0, 3) &&
    (t.each(["Width", "Height"], function (n, i) {
      ...
      function s(n, i, r, h) {
        return (
          t.each(e, function () {
            ;(i -= parseFloat(t.css(n, "padding" + this)) || 0),
              r && (i -= parseFloat(t.css(n, "border" + this + "Width")) || 0),
              h && (i -= parseFloat(t.css(n, "margin" + this)) || 0)
          }),
          i
        )
      }
  ...
  return (n.ui.plugin = {
    add: function (e, i, o) {
      var t,
        u = n.ui[e].prototype
      for (t in o)
        (u.plugins[t] = u.plugins[t] || []), u.plugins[t].push([i, o[t]])
    },
    call: function (n, e, i, o) {
      ...
      if (
        u &&
        (o ||
          (n.element[0].parentNode && 11 !== n.element[0].parentNode.nodeType))
      )
        for (t = 0; t < u.length; t++)
          n.options[u[t][0]] && u[t][1].apply(n.element, i)
    },
  })
})
!(function (e) {
    ...
    _resolveClassesValues: function (i, n) {
      ...
      return (
        t.each(i, function (s) {
          ...
          ;(l = t.trim(l.replace(e, ""))),
            (o[s] = (l + " " + i[s]).replace(/\s+/g, " "))
        }),
        o
      )
    },
    ...
    return this[0].labels && this[0].labels.length
      ...
      : ((n = this.eq(0).parents("label")),
        (i = this.attr("id")) &&
          ...
          (s = "label[for='" + e.ui.escapeSelector(i) + "']"),
      ...
      e.ui.formResetMixin,
      {
        ...
        _getCreateOptions: function () {
          ...
          return (
            ...
            null != (i = this.element[0].disabled) && (o.disabled = i),
            o
          )
        },
        _create: function () {
        ...
        _getRadioGroup: function () {
          var i = this.element[0].name,
            t = "input[name='" + e.ui.escapeSelector(i) + "']"
          return i
            ? (this.form.length
          ...
          this._toggleClass(
            ...
            this.options.icon &&
              ...
              this._toggleClass(
                ...
                i
              )._toggleClass(this.icon, null, "ui-icon-blank", !i),
            "radio" === this.type &&
      ...
      drag: function (e, s, i) {
        ...
        for (f = i.snapElements.length - 1; f >= 0; f--)
          (h =
            ...
            i.snapElements[f].width),
            (c =
              (p = i.snapElements[f].top - i.margins.top) +
              i.snapElements[f].height),
            v < a - u ||
            m > h + u ||
            P < p - u ||
            _ > c + u ||
  ...
  return (
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _hasScroll: function (i, e) {
        ...
        var s,
          h = e && "left" === e ? "scrollLeft" : "scrollTop"
      ...
      _mouseStart: function (i) {
        ...
        return (
          ...
          n.containment &&
            ((e += t(n.containment).scrollLeft() || 0),
      ...
      _mouseStop: function (i) {
        ...
        return (
          this._helper &&
            ...
            (a =
              parseFloat(p.element.css("left")) +
                (p.position.left - p.originalPosition.left) || null),
            (l =
              parseFloat(p.element.css("top")) +
      ...
      _change: {
        ...
        se: function (i, e, s) {
          return t.extend(
            ...
            this._change.e.apply(this, [i, e, s])
          )
        },
        sw: function (i, e, s) {
          return t.extend(
            this._change.s.apply(this, arguments),
            this._change.w.apply(this, [i, e, s])
          )
        },
        ne: function (i, e, s) {
          return t.extend(
      ...
      resize: function (i, e) {
        ...
        t(h.alsoResize).each(function () {
          var i = t(this),
            ...
            h = {},
            n = i.parents(e.originalElement[0]).length
              ? ["width", "height"]
    ...
    t.ui.plugin.add("resizable", "ghost", {
      start: function () {
        ...
        ;(i.ghost = i.originalElement.clone()),
          ...
          !1 !== t.uiBackCompat &&
            "string" == typeof i.options.ghost &&
            i.ghost.addClass(this.options.ghost),
      ...
      resize: function () {
        ...
        ;(s.grid = l),
          ...
          /^(se|s|e)$/.test(a)
            ...
            ? ((e.size.width = u),
              (e.size.height = f),
              (e.position.top = o.top - g))
            : /^(sw)$/.test(a)
            ? ((e.size.width = u),
              (e.size.height = f),
              (e.position.left = o.left - d))
            : ((f - p <= 0 || u - r <= 0) &&
                (i = e._getPaddingPlusBorderDimensions(this)),
              f - p > 0
                ? ((e.size.height = f), (e.position.top = o.top - g))
                : ((f = p - i.height),
                  (e.size.height = f),
                  (e.position.top = o.top + n.height - f)),
              u - r > 0
    ...
    i.widget("ui.dialog", {
      ...
      _setOption: function (t, e) {
        ...
        "disabled" !== t &&
          ...
          "draggable" === t &&
            ((o = n.is(":data(ui-draggable)")) && !e && n.draggable("destroy"),
      ...
      _allowInteraction: function (t) {
        return (
          !!i(t.target).closest(".ui-dialog").length ||
...
;(function ($, Drupal, drupalSettings, _, Backbone, JSON, storage) {
  ...
  var cachedPermissionsHash = storage.getItem(
  ...
  function initContextual($contextual, html) {
    ...
    var destination = "destination=".concat(
      Drupal.encodePath(Drupal.url(drupalSettings.path.currentPath))
    )
        ...
        if (html && html.length) {
          window.setTimeout(function () {
            initContextual(
              $context
                .find(
                  '[data-contextual-id="'.concat(contextualID.id, '"]:empty')
                )
                .eq(0),
              html
            )
            ...
            _.each(results, function (html, contextualID) {
              ...
              if (html.length > 0) {
                $placeholders = $context.find(
                  '[data-contextual-id="'.concat(contextualID, '"]')
                )
    ...
    c = function (e, t) {
      return !(
        ...
        (function (e, t) {
          ...
          var n = r.call(e, "details>summary:first-of-type")
            ? e.parentElement
            : e
  ...
  ;(e.focusable = function (e, t) {
    ...
    (e.tabbable = function (e, t) {
      var n = [],
        r = []
      return (
        o(e, (t = t || {}).includeContainer, d.bind(null, t)).forEach(function (
          e,
          t
        ) {
          var o = i(e)
          0 === o
            ? n.push(e)
            : r.push({ documentOrder: t, tabIndex: o, node: e })
        }),
        r
          .sort(a)
          .map(function (e) {
...
;(function ($, Drupal, drupalSettings) {
  var handleFragmentLinkClickOrHashChange =
    function handleFragmentLinkClickOrHashChange(e, $target) {
  ...
  Drupal.verticalTab.prototype = {
    focus: function focus() {
      ...
      this.link.append(
        '<span id="active-vertical-tab" class="visually-hidden">'.concat(
          Drupal.t("(active tab)"),
          "</span>"
        )
      )
...
;(function ($, Drupal, drupalSettings) {
  ...
  Drupal.tableDrag.prototype.initColumns = function () {
    ...
    Object.keys(this.tableSettings || {}).forEach(function (group) {
      Object.keys(_this2.tableSettings[group]).some(function (tableSetting) {
        var field = $table
          .find(".".concat(_this2.tableSettings[group][tableSetting].target))
          .eq(0)
      ...
      if (hidden && cell[0]) {
        ...
        $table
          ...
          .each(_this2.addColspanClass(columnIndex))
      }
    })
    this.displayColumns(showWeight)
  }
    ...
    var _loop = function _loop(n) {
      ...
      if (y > rowY - rowHeight && y < rowY + rowHeight) {
        if (_this3.indentEnabled) {
          if (
            Object.keys(_this3.rowObject.group).some(function (o) {
  ...
  Drupal.tableDrag.prototype.updateField = function (changedRow, group) {
    ...
    if (
      ...
      if (
        $previousRow.is(".draggable") &&
        $previousRow.find(".".concat(group)).length
      ) {
        if (this.indentEnabled) {
          if (
        ...
        $nextRow.find(".".concat(group)).length
      ) {
        if (this.indentEnabled) {
          if (
  ...
  Drupal.tableDrag.prototype.row.prototype.findChildren = function (
    ...
    if (addClasses && rows.length) {
      $(rows[rows.length - 1])
        .find(".js-indentation:nth-child(".concat(parentIndentation + 1, ")"))
  ...
  $.extend(Drupal.theme, {
    tableDragChangedMarker: function tableDragChangedMarker() {
      return '<abbr class="warning tabledrag-changed" title="'.concat(
        Drupal.t("Changed"),
        '">*</abbr>'
      )
    },
    ...
    tableDragChangedWarning: function tableDragChangedWarning() {
      return '<div class="tabledrag-changed-warning messages messages--warning" role="alert">'
        .concat(Drupal.theme("tableDragChangedMarker"), " ")
        .concat(Drupal.t("You have unsaved changes."), "</div>")
    },
    ...
    tableDragHandle: function tableDragHandle() {
      return '<a href="#" title="'.concat(
        Drupal.t("Drag to re-order"),
  ...
  Drupal.behaviors.activeLinks = {
    attach: function attach(context) {
      ...
      var querySelector = path.currentQuery
        ? "[data-drupal-link-query='".concat(queryString, "']")
        : ":not([data-drupal-link-query])"
      var originalSelectors = [
        '[data-drupal-link-system-path="'.concat(path.currentPath, '"]'),
      ]
      var selectors
      ...
      selectors = [].concat(
        ...
        originalSelectors.map(function (selector) {
          return ""
            .concat(selector, '[hreflang="')
            .concat(path.currentLanguage, '"]')
        })
      )
  ...
  Drupal.behaviors.filterStatus = {
    attach: function attach(context, settings) {
      ...
      once(
        ...
        var $row = $context
          .find("#".concat($checkbox.attr("id").replace(/-status$/, "-weight")))
          .closest("tr")
    ...
    attach: function attach(context) {
      DetailsSummarizedContent.instances =
        DetailsSummarizedContent.instances.concat(
          once("details", "details", context).map(function (details) {
  ...
  $.extend(CollapsibleDetails.prototype, {
    setupSummaryPolyfill: function setupSummaryPolyfill() {
      ...
      $('<a class="details-title"></a>')
        .attr("href", "#".concat(this.$node.attr("id")))
  ...
  Drupal.behaviors.filterFilterHtmlUpdating = {
    ...
    _updateAllowedTags: function _updateAllowedTags() {
      ...
      if (!_.isEmpty(this.autoTags)) {
        ...
        var userTagsWithoutOverrides = _.omit(
          this.userTags,
        ...
        this.$allowedHTMLFormItem.val(
          ""
            .concat(this._generateSetting(userTagsWithoutOverrides), " ")
            .concat(this._generateSetting(this.autoTags))
        )
      } else {
      ...
      return _.reduce(
        ...
        function (setting, rule, tag) {
          ...
          if (rule.restrictedTags.allowed.attributes.length) {
            setting += " ".concat(
              rule.restrictedTags.allowed.attributes.join(" ")
            )
          }

          if (rule.restrictedTags.allowed.classes.length) {
            setting += ' class="'.concat(
              rule.restrictedTags.allowed.classes.join(" "),
              '"'
            )
          }
...
;(function ($, Drupal) {
  ...
  var overviewForm = document.querySelector(
    'form[data-drupal-selector="markdown-overview"]'
  )
  if (overviewForm && !overviewForm.jsProcessed) {
    overviewForm.jsProcessed = true
    var submit = overviewForm.querySelector(
      'input[name="op"],button[name="op"]'
    )
  ...
  var restorePreviousInput = function (input) {
    ...
    if (
      ...
      $input.data("originalChecked") !== void 0
    ) {
  ...
  $document.off("state:checked").on("state:checked", function (e) {
    ...
    attach: function attach(context) {
      ...
      $wrapper.once("markdown-summary").each(function () {
        ...
        $inputs.each(function () {
          ...
          var $item = $input.closest(
            ".js-vertical-tabs-pane,.vertical-tabs__pane"
          )
              ...
              switch (summaryType) {
                case "parser":
                  if ($input[0].nodeName === "SELECT") {
                    ...
                    var parser =
                      $input.data("markdownSummaryValue") || $input.val()
                    summary.push(parser)
                  }
                  break
                ...
                case "render_strategy":
                  ...
                  if ($selected.val() === "filter") {
                    var $allowedHtml = $item.find(
                      '[data-markdown-element="allowed_html"]'
                    )
                    var $reset = $item.find(
                      '[data-markdown-element="allowed_html_reset"]'
                    )
                ...
                case "extension":
                  ...
                  var $label = $parent.is(labelSelector)
                    ? $parent
                    : $parent.find(labelSelector)
                  if (!$label.data("original-label")) {
                    $label.data("original-label", $label.html())
                  }
                  var originalLabel =
                    $label.data("original-label") || Drupal.t("Enable")
                  ...
                  if (!$input.data("markdownInstalled")) {
                    ...
                    if (verticalTab.item && verticalTab.item[0]) {
                      verticalTab.item[0].classList.add(
                        "installable-library-not-installed"
                      )
                    }
                  } else {
                    var enabled = false
                    ...
                    var requiredBy = []
                      .concat($input.data("markdownRequiredBy"))
                      .map(function (id) {
                        var $dependent = $inputs.filter(
                          '[data-markdown-element="extension"][data-markdown-id="' +
                            id +
                            '"]'
                        )
                        if ($dependent[0]) {
                          return $dependent.is(":checked")
                            ? $dependent.data("markdownLabel")
                            : ""
                        }
                      })
                      .filter(Boolean)
                    if (requiredBy.length) {
                      ...
                      $label.html(
                        Drupal.t("@label (required by: @extensions)", variables)
                      )
                      summary.push(
                        Drupal.t("Required by: @extensions", variables)
                      )
                      ...
                      $label.html(
                        Drupal.t("@label (required by: @bundle)", variables)
                      )
                      ...
                      summary.push(
                        enabled ? Drupal.t("Enabled") : Drupal.t("Disabled")
                      )
                    }

                    if (verticalTab.item && verticalTab.item[0]) {
                      verticalTab.item[0].classList.remove(
                        "installable-library-enabled",
                        "installable-library-disabled"
                      )
                      verticalTab.item[0].classList.add(
                        enabled
                          ? "installable-library-enabled"
                    ...
                    ;[]
                      .concat($input.data("markdownRequires"))
                      .map(function (id) {
                        var $requirement = $inputs.filter(
                          '[data-markdown-element="extension"][data-markdown-id="' +
                            id +
                            '"]'
                        )
...
;(function (Drupal) {
  ...
  Reset.prototype.reset = function reset(e) {
    ...
    if (this.target.type === "checkbox") {
      ...
      switch (this.target.nodeName.toLowerCase()) {
        case "radio":
        case "select":
          var option = this.target.querySelector(
  ...
  Drupal.behaviors.markdownReset = {
    attach: function attach(context) {
      context
        .querySelectorAll('[data-markdown-element="reset"]')
        .forEach(function (element) {
          ...
          element.__markdownReset__ = new Reset(
            id,
            element,
            target,
            defaultValue
...
;(function ($, _, Drupal, document) {
  Drupal.editorConfiguration = {
    ...
    featureIsAllowedByFilters: function featureIsAllowedByFilters(feature) {
        ...
        for (var r = 0; r < feature.rules.length; r++) {
          ...
          for (var p = 0; p < properties.length; p++) {
            ...
            for (var pv = 0; pv < featureRule.required[property].length; pv++) {
              ...
              universe[requiredTags][
                "".concat(property, ":").concat(propertyValue)
              ] = false
            }
          }
        }
      ...
      return Object.keys(Drupal.filterConfiguration.statuses).every(function (
        filterID
      ) {
        return filterStatusAllowsFeature(
  ...
  Drupal.filterConfiguration = {
    ...
    update: function update() {
      Object.keys(Drupal.filterConfiguration.statuses || {}).forEach(function (
        filterID
      ) {
        Drupal.filterConfiguration.statuses[filterID].active = $(
          '[name="filters['.concat(filterID, '][status]"]')
        ).is(":checked")

        if (Drupal.filterConfiguration.liveSettingParsers[filterID]) {
          Drupal.filterConfiguration.statuses[filterID].rules =
            Drupal.filterConfiguration.liveSettingParsers[filterID].getRules()
        }
      })
    },
  }
