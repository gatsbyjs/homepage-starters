...
;(function (Drupal, debounce, CKEDITOR, $, displace, AjaxCommands) {
  Drupal.editors.ckeditor = {
          ...
          if (!editable.isInline()) {
            editor.on(
              ...
              function (evt) {
                ...
                var scrollable = CKEDITOR.env.quirks
                  ? doc.getBody()
    ...
    attachInlineEditor: function attachInlineEditor(
      element,
      format,
      mainToolbarId,
      floatedToolbarId
  ...
  Drupal.ckeditor = {
    ...
    openDialog: function openDialog(
      ...
      $target
        ...
        .remove()
      var classes = dialogSettings.dialogClass
      ...
      var $content = $(
        '<div class="ckeditor-dialog-loading"><span style="top: -40px;" class="ckeditor-dialog-loading-link">'.concat(
          Drupal.t("Loading..."),
          "</span></div>"
        )
      )
...
;(function ($, CKEDITOR) {
  var convertToOffCanvasCss = function convertToOffCanvasCss(originalCss) {
    ...
    var css = originalCss
      ...
      .trim()
      .replace(/}/g, "}".concat(selectorPrefix))
      .replace(/,/g, ",".concat(selectorPrefix))
  ...
  var addCkeditorOffCanvasCss = function addCkeditorOffCanvasCss() {
    ...
    var storedOffCanvasCss = window.localStorage.getItem(
      "Drupal.off-canvas.css.".concat(editorCssPath).concat(dialogCssPath)
    )
    ...
    $.when($.get(editorCssPath), $.get(dialogCssPath)).done(function (
      editorCss,
      dialogCss
    ) {
      ...
      var cssToInsert =
        "#drupal-off-canvas .cke_inner * {background: transparent;}\n          "
              ...
              ;(e.state.delayingBlurEvent = !0),
                setTimeout(function () {
                  e.state.delayingBlurEvent &&
                    ((e.state.delayingBlurEvent = !1), e.state.focused && Sr(e))
                }, 100)
            }
            function kr(e, t) {
              e.state.delayingBlurEvent &&
                ...
                function (e) {
                  var r = (function (e) {
                    ...
                    return e
                      ...
                      .replace("#image_max_size#", X(n.options.imageMaxSize, r))
                  })(e)
...
;(function (Drupal) {
  ...
  Drupal.theme.mediaEmbedEditButton = function () {
    return '<button class="media-library-item__edit">'.concat(
      Drupal.t("Edit media"),
      "</button>"
    )
  }
