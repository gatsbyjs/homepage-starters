    ...
    e.widget("ui.autocomplete", {
      ...
      _create: function () {
        var t,
          ...
          u = "input" === n
        ;(this.isMultiLine =
          o || (!u && this._isContentEditable(this.element))),
  ...
  Drupal.behaviors.autocomplete = {
    attach: function attach(context) {
      ...
      if ($autocomplete.length) {
        var blacklist = $autocomplete.attr(
    ...
    attach: function attach(context) {
      ...
      $context
        ...
        .drupalSetSummary(function (context) {
          ...
          var revisionCheckbox = $revisionContext.find(
      ...
      $context
        ...
        .drupalSetSummary(function (context) {
          ...
          var translate
          var $checkbox = $translationContext.find(
...
;(function (Modernizr, Drupal, once) {
    ...
    _createClass(_class, null, [
      {
        ...
        value: function attachDescription(element, help, id) {
          ...
          if (
            ...
            description =
              Drupal.DatepickerPolyfill.descriptionWrapperElement(id)
  ...
  Drupal.theme.dateTimeHelp = function (_ref2) {
    ...
    return '<div class="no-native-datepicker-help">\n       <span id="'
      .concat(dateId, '">')
      .concat(dateDesc, '</span> <span id="')
      .concat(timeId, '">')
      .concat(timeDesc, "</span>\n     </div>")
  }
...
;(function ($, Drupal, window) {
  function TableResponsive(table) {
    ...
    this.$table.before(
      $('<div class="tableresponsive-toggle-columns"></div>').append(this.$link)
    )
    $(window)
      .on(
  ...
  $.extend(TableResponsive.prototype, {
    eventhandlerEvaluateColumnVisibility:
      function eventhandlerEvaluateColumnVisibility(e) {
        var pegged = parseInt(this.$link.data("pegged"), 10)
        var hiddenLength = this.$headers.filter(
    ...
    eventhandlerToggleColumns: function eventhandlerToggleColumns(e) {
      e.preventDefault()
      var self = this
      var $hiddenHeaders = this.$headers.filter(
        ".priority-medium:hidden, .priority-low:hidden"
      )
